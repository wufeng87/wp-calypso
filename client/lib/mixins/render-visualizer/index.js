...
var RenderVisualizerMixin = {
	...
	getReasonForReRender: function( prevProps, prevState ) {
		var nextState = this.state, nextProps = this.props, key;
	...
	highlightChange: function( change ) {
		var parentNode = ReactDom.findDOMNode( this ), ANIMATION_DURATION = 500, self = this;
...
export const {
	UPDATE_RENDER_LOG_POSITION_TIMEOUT_MS,
	MAX_LOG_LENGTH,
	STATE_CHANGES,
	renderLog,
	renderCount,
	renderLogContainer,
	renderLogDetail,
	renderLogRenderCount,
	updateRenderLogPositionTimeout,
	styling,
	componentDidMount,
	componentDidUpdate,
	...
	removeRenderLogNode,
	addToRenderLog,
	getReasonForReRender,
	highlightChange,
} = RenderVisualizerMixin;
