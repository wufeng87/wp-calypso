	...
	buildUpdateTemplate: function() {
		...
		switch ( status ) {
			...
			case 'deleting':
				...
				updateText = (
					<span>
						{ trashText } <span className="loading-dot">.</span>
			...
			case 'updating':
				updateText = (
					<span>
						{ strings.updating } <span className="loading-dot">.</span>
						<span className="loading-dot">.</span>
						<span className="loading-dot">.</span>
					</span>
				);
			...
			case 'restoring':
				updateText = (
					<span>
						{ strings.restoring } <span className="loading-dot">.</span>
						<span className="loading-dot">.</span>
						<span className="loading-dot">.</span>
					</span>
				);
			...
			<div key={ post.global_ID + '-update' } className="updated-confirmation">
				<div className={ updateClass }>
					<div className="conf-alert_con">
						<span className="conf-alert_title">
							{ updateText }
						</span>
						{ undoTemplate }
					</div>
