...
const exported = {
	shouldComponentUpdateNotices( currentNotices, nextNotices ) {
		...
		if (
			currentNotices.completed && currentNotices.completed.length !== nextNotices.completed.length
		) {
			return true;
		}
		return false;
	...
	showNotification() {
		...
		if ( logNotices.completed.length > 0 && logNotices.errors.length > 0 ) {
			...
			const sampleLog = logNotices.completed[ 0 ].status === 'inProgress'
				...
				showDismiss = ! ( sampleLog.plugin.wp_admin_settings_page_url &&
					'ACTIVATE_PLUGIN' === sampleLog.action );
		...
		switch ( action ) {
					...
					switch ( combination ) {
						case '1 site 1 plugin':
							return i18n.translate(
								'Successfully installed %(plugin)s on %(site)s.',
								{ args: translateArg },
							);
			...
			case 'REMOVE_PLUGIN':
				switch ( combination ) {
					case '1 site 1 plugin':
						return i18n.translate(
							'Successfully removed %(plugin)s on %(site)s.',
							{ args: translateArg },
						);
					case '1 site n plugins':
						return i18n.translate(
			...
			case 'UPDATE_PLUGIN':
				switch ( combination ) {
					case '1 site 1 plugin':
						return i18n.translate(
							'Successfully updated %(plugin)s on %(site)s.',
							{ args: translateArg },
						);
					case '1 site n plugins':
						return i18n.translate(
			...
			case 'ACTIVATE_PLUGIN':
				switch ( combination ) {
					case '1 site 1 plugin':
						return i18n.translate(
							'Successfully activated %(plugin)s on %(site)s.',
							{ args: translateArg },
						);
					case '1 site n plugins':
						return i18n.translate(
			...
			case 'DEACTIVATE_PLUGIN':
				switch ( combination ) {
					case '1 site 1 plugin':
						return i18n.translate(
							'Successfully deactivated %(plugin)s on %(site)s.',
							{ args: translateArg },
						);
					case '1 site n plugins':
						return i18n.translate(
		...
		switch ( action ) {
			...
			case 'REMOVE_PLUGIN':
				switch ( combination ) {
					...
					case '1 site n plugins':
						return i18n.translate(
							'Removing %(numberOfPlugins)d plugins on %(site)s.',
							{ args: translateArg },
						);
					case 'n sites 1 plugin':
						return i18n.translate(
							'Removing %(plugin)s on %(numberOfSites)d sites.',
							{ args: translateArg },
						);
					case 'n sites n plugins':
						return i18n.translate(
		...
		switch ( action ) {
			...
			case 'REMOVE_PLUGIN':
				switch ( sampleLog.error.error ) {
					...
					default:
						return i18n.translate(
							'An error occurred while removing %(plugin)s on %(site)s.',
							{ args: translateArg },
						);
				}
			...
			case 'UPDATE_PLUGIN':
				switch ( sampleLog.error.error ) {
					...
					default:
						...
						return i18n.translate(
							'An error occurred while updating %(plugin)s on %(site)s.',
							{ args: translateArg },
						);
				}
