	...
	definitions: function( site ) {
		return {
			...
			theme: {
				...
				body: i18n.translate(
					"{{p1}}The theme is the look and feel of your WordPress. A theme doesn't change your content, just the way it is presented.{{/p1}}{{p2}}Choose a theme based on your taste. You can always change it later.{{/p2}}",
					{
						comment: 'p1 and p2 are paragraph tags.',
						components: {
							p1: <p />,
			...
			customize: {
				...
				body: i18n.translate(
					'{{p1}}You can use the Customizer to add header and background images, or tweak your theme.  {{/p1}}{{p2}}You can find the Customizer in My Sites.{{/p2}}',
					{
						comment: 'p1 and p2 are paragraph tags.',
						components: {
							p1: <p />,
			...
			plans: {
				...
				body: i18n.translate(
					'{{p1}}Plans upgrade your WordPress with storage, design options, and a custom domain.{{/p1}}{{p2}}A plan will also remove ads and enable audio and video uploads.{{/p2}}',
					{
						comment: 'p1 and p2 are paragraph tags',
						components: {
							p1: <p />,
			...
			page: {
				...
				body: i18n.translate(
					'{{p1}}Pages are sections of your site that contain information for your visitors.{{/p1}}{{p2}}Think about creating an About or Contact Us page to get started.{{/p2}}',
					{
						comment: 'p1 and p2 are paragraph tags.',
						components: {
							p1: <p />,
			...
			site: {
				...
				body: i18n.translate(
					'{{p1}}Start a new WordPress site or blog.{{/p1}}{{p2}}Your own WordPress is free and a great way to create a home on the web.{{/p2}}',
					{
						comment: 'p1 and p2 are paragraph tags.',
						components: {
							p1: <p />,
			...
			profile: {
				...
				body: i18n.translate(
					"{{p1}}Your profile is how other users see you.{{/p1}}{{p2}}Share a blurb about yourself to let others know what you're all about.{{/p2}}",
					{
						comment: 'p1 and p2 are paragraph tags.',
						components: {
							p1: <p />,
			...
			follow: {
				...
				body: i18n.translate(
					'{{p1}}Follow some other sites to stay informed and find inspiration.{{/p1}}{{p2}}All of the content you follow shows up in your Reader.{{/p2}}',
					{
						comment: 'p1 and p2 are paragraph tags.',
						components: {
							p1: <p />,
...
export const { defaultSequence, hasPlanSequence, userOnly, definitions } = exported;
