					...
					<Card className="me-notification-settings">
						...
						>
							...
							<FormFieldset>
								...
								>
									<option value="never">
										{ this.translate( 'Never send email' ) }
									</option>
									<option value="instantly">
										{ this.translate( 'Send email instantly' ) }
									</option>
									<option value="daily">
										{ this.translate( 'Send email daily' ) }
									</option>
									<option value="weekly">
										{ this.translate( 'Send email every week' ) }
									</option>
								</FormSelect>
							</FormFieldset>
							...
							<FormFieldset>
								<FormLegend>
									{ this.translate( 'Jabber Subscription Delivery' ) }
								</FormLegend>
								<FormLabel>
									<FormCheckbox
							...
							<FormFieldset>
								...
								>
									<option value="0">
										{ this.getDeliveryHourLabel( 0 ) }
									</option>
									<option value="2">
										{ this.getDeliveryHourLabel( 2 ) }
									</option>
									<option value="4">
										{ this.getDeliveryHourLabel( 4 ) }
									</option>
									<option value="6">
										{ this.getDeliveryHourLabel( 6 ) }
									</option>
									<option value="8">
										{ this.getDeliveryHourLabel( 8 ) }
									</option>
									<option value="10">
										{ this.getDeliveryHourLabel( 10 ) }
									</option>
									<option value="12">
										{ this.getDeliveryHourLabel( 12 ) }
									</option>
									<option value="14">
										{ this.getDeliveryHourLabel( 14 ) }
									</option>
									<option value="16">
										{ this.getDeliveryHourLabel( 16 ) }
									</option>
									<option value="18">
										{ this.getDeliveryHourLabel( 18 ) }
									</option>
									<option value="20">
										{ this.getDeliveryHourLabel( 20 ) }
									</option>
									<option value="22">
										{ this.getDeliveryHourLabel( 22 ) }
									</option>
								</FormSelect>
