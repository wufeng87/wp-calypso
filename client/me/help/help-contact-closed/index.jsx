...
export default localize( props => {
	...
	return (
		<div className="help-contact-closed">
			<FormSectionHeading>
				{ translate( 'Limited Support This Week' ) }
			</FormSectionHeading>
			<p>
				{ translate(
			...
			<HelpContactClosedDetail icon="help">
				{ translate( 'The {{link}}forums{{/link}} remain open and staffed during this time.', {
					components: {
						link: (
							<a href="https://forums.wordpress.com/" target="_blank" rel="noopener noreferrer" />
						),
					},
				} ) }
			...
			<HelpContactClosedDetail icon="book">
				{ translate(
						...
						'post{{/first_post_link}}, and {{find_readers_link}}finding your readers{{/find_readers_link}}.',
					{
						components: {
							guide_link: (
								<a href="https://learn.wordpress.com/" target="_blank" rel="noopener noreferrer" />
							),
							support_doc_link: (
								<a href={ supportUrls.SUPPORT_ROOT } target="_blank" rel="noopener noreferrer" />
							),
							get_started_link: (
								<a href={ supportUrls.START } target="_blank" rel="noopener noreferrer" />
							),
							first_post_link: (
								<a href={ supportUrls.CREATE } target="_blank" rel="noopener noreferrer" />
							),
							find_readers_link: (
								<a href={ supportUrls.CONNECT } target="_blank" rel="noopener noreferrer" />
							),
						},
					},
				) }
