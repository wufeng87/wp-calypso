...
class RegistrantExtraInfoFrForm extends React.PureComponent {
	...
	renderPersonalFields() {
		...
		const translate = this.props.translate;
		const { dobYears, dobMonths, dobDays } = this.state;
		const { countryOfBirth, placeOfBirth, postalCodeOfBirth } = defaults(
			{},
				...
				<FormFieldset>
					...
					<div className="registrant-extra-info__dob-inputs">
						<div className="registrant-extra-info__dob-column">
							...
							<FormTextInput
								className="registrant-extra-info__dob-year"
								id="dobYears"
								value={ dobYears }
								type="number"
								placeholder={ translate( 'YYYY', {
									comment:
										'Placeholder text for the year part of a date input. Indicates that the user should enter a year as a 4 digit value', // eslint-disable-line max-len
								} ) }
						...
						<div className="registrant-extra-info__dob-column">
							...
							<FormTextInput
								className="registrant-extra-info__dob-month"
								id="dobMonths"
								value={ dobMonths }
								max="2"
								type="number"
								placeholder={ translate( 'MM', {
									comment:
										'Placeholder text for the month part of a date input. Indicates that the user should enter a month as a 2 digit value', // eslint-disable-line max-len
								} ) }
								onChange={ this.handleDobChangeEvent }
							/>
						</div>
						<div className="registrant-extra-info__dob-column">
							...
							<FormTextInput
								className="registrant-extra-info__dob-day"
								id="dobDays"
								value={ dobDays }
								max="2"
								type="number"
								placeholder={ translate( 'DD', {
									comment:
										'Placeholder text for the day part of a date input. Indicates that the user should enter a day as a 2 digit value', // eslint-disable-line max-len
								} ) }
								onChange={ this.handleDobChangeEvent }
							/>
						</div>
					...
					<FormSettingExplanation>
						{ translate( 'Year/Month/Day - e.g. 1970/12/31', {
							comment:
								'This is describing a date format with fixed fields, so please do not ' +
