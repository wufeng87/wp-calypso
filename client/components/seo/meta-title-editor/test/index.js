...
describe( 'SEO', () => {
	describe( 'Title Format Editor', () => {
		describe( '#nativeToRaw', () => {
			it( 'should produce empty formats', () => expect( nativeToRaw( [] ) ).to.eql( [] ) );
		...
		describe( '#rawToNative', () => {
			it( 'should handle empty strings', () => expect( rawToNative( [] ) ).to.eql( [] ) );
		...
		describe( '#fromApi', () => {
			it( 'should produce empty formats', () => expect( fromApi( {} ) ).to.eql( {} ) );
		...
		describe( '#toApi', () => {
			it( 'should produce empty formats', () => expect( toApi( {} ) ).to.eql( {} ) );
