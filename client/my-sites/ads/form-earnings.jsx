...
class AdsFormEarnings extends Component {
	...
	infoNotice() {
		...
		return (
			<div className="ads__module-content-text module-content-text module-content-text-info">
				<p>
					{ translate( 'Payments can have the following statuses:' ) }
				</p>
				<ul className="ads__earnings-history-statuses-list">
					...
					<li className="ads__earnings-history-status">
						<strong>
							{ translate( 'Pending (Missing Tax Info):' ) }{' '}
						</strong>
						{ translate(
					...
					<li className="ads__earnings-history-status">
						<strong>
							{ translate( 'Pending (Invalid PayPal):' ) }{' '}
						</strong>
						{ translate(
				...
				rows.push(
					<tr key={ type + '-' + period }>
						<td className="ads__earnings-history-value">
							{ this.swapYearMonth( period ) }
						</td>
						<td className="ads__earnings-history-value">
							${ numberFormat( earnings[ period ].amount, 2 ) }
						</td>
						<td className="ads__earnings-history-value">
							{ earnings[ period ].pageviews }
						</td>
						<td className="ads__earnings-history-value">
