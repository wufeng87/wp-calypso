...
const ThemeSheet = React.createClass( {
	...
	renderBar() {
		...
		return (
			<div className="theme__sheet-bar">
				...
				<span className="theme__sheet-bar-tag">
					{ tag }
				</span>
			</div>
		);
	...
	renderScreenshot() {
		...
		const img =
			screenshotFull && <img className="theme__sheet-img" src={ screenshotFull + '?w=680' } />;
		...
		return (
			<Card className="theme__sheet-card-support">
				...
				<div className="theme__sheet-card-support-details">
					...
					<small>
						{ i18n.translate( 'Get in touch with our support team' ) }
					</small>
				</div>
				<Button
		...
		return (
			<Card className="theme__sheet-card-support">
				...
				<div className="theme__sheet-card-support-details">
					...
					<small>
						{ i18n.translate( 'Get help from the experts in our CSS forum' ) }
					</small>
				</div>
				<Button
					primary={ buttonCount === 1 }
