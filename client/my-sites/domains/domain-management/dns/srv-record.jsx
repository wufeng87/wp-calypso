	...
	render() {
		...
		return (
			<div className={ classes }>
				...
				<FormFieldset>
					<FormLabel>
						{ this.translate( 'Service', { context: 'Dns Record' } ) }
					</FormLabel>
					<FormTextInput
						name="service"
					...
					/>
					{ ! isServiceValid
						? <FormInputValidation text={ this.translate( 'Invalid Service' ) } isError={ true } />
						: null }
				</FormFieldset>

				<FormFieldset>
					<FormLabel>
						{ this.translate( 'Protocol', { context: 'Dns Record' } ) }
					</FormLabel>

					<FormSelect name="protocol" onChange={ this.props.onChange } value={ protocol }>
						{ options }
					</FormSelect>
				</FormFieldset>
				...
				<FormFieldset>
					<FormLabel>
						{ this.translate( 'Priority', { context: 'Dns Record' } ) }
					</FormLabel>
					<FormTextInput
						name="aux"
						isError={ ! isAuxValid }
					...
					/>
					{ ! isAuxValid
						? <FormInputValidation text={ this.translate( 'Invalid Priority' ) } isError={ true } />
						: null }
				</FormFieldset>

				<FormFieldset>
					<FormLabel>
						{ this.translate( 'Weight', { context: 'Dns Record' } ) }
					</FormLabel>
					<FormTextInput
						name="weight"
					...
					/>
					{ ! isWeightValid
						? <FormInputValidation text={ this.translate( 'Invalid Weight' ) } isError={ true } />
						: null }
				</FormFieldset>

				<FormFieldset>
					<FormLabel>
						{ this.translate( 'Target Host', { context: 'Dns Record' } ) }
					</FormLabel>
					<FormTextInput
						name="target"
				...
				<FormFieldset>
					<FormLabel>
						{ this.translate( 'Target Port', { context: 'Dns Record' } ) }
					</FormLabel>
					<FormTextInput
						name="port"
						isError={ ! isPortValid }
					...
					{ ! isPortValid
						? <FormInputValidation
								text={ this.translate( 'Invalid Target Port' ) }
								isError={ true }
							/>
						: null }
				</FormFieldset>
