...
import upgradesController from './controller';
...
export default function() {
	...
	if ( config.isEnabled( 'upgrades/checkout' ) ) {
		...
		page( '/checkout/no-site', controller.noSite, upgradesController.sitelessCheckout );

		page( '/checkout/:domain/:product?', controller.siteSelection, upgradesController.checkout );
