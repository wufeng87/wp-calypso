 ...
 */
import CartItems from 'my-sites/upgrades/cart/cart-items';
import CartCoupon from 'my-sites/upgrades/cart/cart-coupon';
import CartTotal from 'my-sites/upgrades/cart/cart-total';
...
export const { propTypes, defaultProps } = CartBody;
