...
const exported = {
	...
	site: function( context, next ) {
		...
		if ( ! activeFilter ) {
			...
			if (
				currentSite &&
				'object' === typeof currentSite.options &&
				'undefined' !== typeof currentSite.options.gmt_offset
			) {
	...
	summary: function( context, next ) {
		...
		if ( siteFragment && 0 === siteId ) {
			...
			const extraProps = context.params.module === 'videodetails'
	...
	follows: function( context ) {
		...
		const siteDomain = site && typeof site.slug !== 'undefined'
			? site.slug
			: route.getSiteFragment( context.path );
