				...
				<Card className={ classes }>
					<div className="most-popular__wrapper">
						<div className="most-popular__item">
							<span className="most-popular__label">
								{ translate( 'Most popular day' ) }
							</span>
							<span className="most-popular__day">
								{ day }
							</span>
						...
						<div className="most-popular__item">
							<span className="most-popular__label">
								{ translate( 'Most popular hour' ) }
							</span>
							<span className="most-popular__hour">
								{ hour }
							</span>
							<span className="most-popular__percentage">
								{ translate( '%(percent)d%% of views', {
