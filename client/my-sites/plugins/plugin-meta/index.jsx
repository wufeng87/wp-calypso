...
class PluginMeta extends Component {
	...
	renderName() {
		...
		return (
			<div className="plugin-meta__name">
	...
	render() {
		...
		const plugin =
			this.props.selectedSite && this.props.sites[ 0 ]
				? this.props.sites[ 0 ].plugin
				: this.props.plugin;
		const path =
			( ! this.props.selectedSite || plugin.active ) && this.getExtensionSettingsPath( plugin );
		...
		return (
			<div className="plugin-meta">
				...
				{ path &&
					<CompactCard href={ addSiteFragment( path, this.props.slug ) }>
