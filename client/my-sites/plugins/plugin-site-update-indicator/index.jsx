...
export default React.createClass( {
	...
	renderUpdate: function() {
		let message, ongoingUpdates = this.getOngoingUpdates(), isUpdating = ongoingUpdates.length > 0;
	...
	render: function() {
		...
		if (
			...
			if ( ! this.props.expanded ) {
				...
				return (
					<span className="plugin-site-update-indicator"><Gridicon icon="sync" size={ 20 } /></span>
				);
