			...
			<Main className="auth auth__connect">
				...
				{ ! config( 'oauth_client_id' )
					? <Notice
						...
						>
							<NoticeAction href="https://developer.wordpress.com/apps/">
								{ this.translate( 'Go to Developer Resources' ) }
							</NoticeAction>
						</Notice>
					: <div className="auth__connect-intro">
							...
							<Button href={ this.props.authUrl }>
								{ this.translate( 'Authorize App' ) }
							</Button>
						</div> }
				<a
					...
					title={ this.translate( 'Visit the Calypso GitHub repository for help' ) }
